...
const rowsjuevesAM = [
    ...
    createData("10:45 - 11:15", "Políticas Públicas en Ciberseguridad en Chile", "Senador Kenneth Pugh, Congreso Nacional"),
    createData("11:15 - 11:40", "Hacia una seguridad ciudadana inteligente", "Sergio Zuñiga"),
    createData("11:40 - 12:10", "Roadmap on SCC development", "Luiza Schuck Azambuja, Taltech"),
];
const rowsjuevesPM = [
    ...
    createData("16:00 - 17:00", "Train the trainers", "Magdalena Ciesielska, U. Técnica de Gdansk, Polonia - Elsa Estevez o Gabriela, UNLP"),
...
const rowsviernesAM = [
    ...
    createData("11:00 - 12:30", "Panel on Teaching cases (PUCRS + local partner)", "Edimara Luciana - Luis Daniel Benavides, UCI - Sabrina Callegaro, PUCRS - Rocio Muñoz, UNLP - Gabriela Diaz, UNS - Humberto Farias, UTFSM-ULS"),
]
...
const rowsviernesPM = [
    ...
    createData("16:15 - 17:30", "Future development is SSC (Companies and Academia) Panel ", "UTFSM, Marijin Jenssen - Elsa Estevez - Marco Peres - Ivan Poduje - Lorena Santana"),
...
const Schedule = () => {
    let even = false;
    return (
        <div className='body schedule-container'>
